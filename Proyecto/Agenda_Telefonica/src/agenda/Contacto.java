...
public class Contacto implements Serializable{
    ...
    public Contacto(String Nombre, int Cantidad_Telefonos, String Correo
            , String Direccion, String Alias, String[] Telefonos) {
    ...
    public String toString() {
        ...
        return Nombre + "; " + Cantidad_Telefonos + "; " + Arrays.toString(Telefonos) 
                + "; " + Correo + "; " + Direccion + "; " 
                + Alias;
